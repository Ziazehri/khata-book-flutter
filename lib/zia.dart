...
class Zia extends StatefulWidget {
  @override
  State<Zia> createState() => _ZiaState();
}

class _ZiaState extends State<Zia> {
  double amountZ = 0;
  final TextEditingController _amountController = TextEditingController();
  static const String keyAmount = "Amount_Zia";
  ...
  Future<void> _updateBalance(double value) async {
    ...
    prefs.setDouble(keyAmount, amountZ);
  }

  Future<void> _loadBalance() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      amountZ = prefs.getDouble(keyAmount) ?? 0;
    });
  }
