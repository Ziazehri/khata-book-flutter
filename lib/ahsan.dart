...
class Ahsan extends StatefulWidget {
  @override
  State<Ahsan> createState() => _AhsanState();
}

class _AhsanState extends State<Ahsan> {
  double amountA = 0;
  final TextEditingController _amountController = TextEditingController();
  static const String keyAmount = "Amount_Ahsan";
  ...
  Future<void> _updateBalance(double value) async {
    ...
    prefs.setDouble(keyAmount, amountA);
  }

  Future<void> _loadBalance() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      amountA = prefs.getDouble(keyAmount) ?? 0;
    });
  }
