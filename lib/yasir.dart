...
class Yasir extends StatefulWidget {
  @override
  State<Yasir> createState() => _YasirState();
}

class _YasirState extends State<Yasir> {
  double amountY = 0;
  final TextEditingController _amountController = TextEditingController();
  static const String keyAmount = "Amount_Yasir";
  ...
  Future<void> _updateBalance(double value) async {
    ...
    prefs.setDouble(keyAmount, amountY);
  }

  Future<void> _loadBalance() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      amountY = prefs.getDouble(keyAmount) ?? 0;
    });
  }
