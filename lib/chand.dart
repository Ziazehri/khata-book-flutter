...
class Chand extends StatefulWidget {
  @override
  State<Chand> createState() => _ChandState();
}

class _ChandState extends State<Chand> {
  double amountC = 0;
  final TextEditingController _amountController = TextEditingController();
  static const String keyAmount = "Amount_Chand";
  ...
  Future<void> _updateBalance(double value) async {
    ...
    prefs.setDouble(keyAmount, amountC);
  }

  Future<void> _loadBalance() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      amountC = prefs.getDouble(keyAmount) ?? 0;
    });
  }
